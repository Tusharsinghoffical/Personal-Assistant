# ⚙️ Mark
### The Ultimate Cross-Platform Personal AI Assistant — By Tushar singh
...
Mark is about making your assistant **hands-free, faster, and easy to extend** — all universal: no hardcoded language, no bundled asset files, works the same on Windows, macOS and Linux.

### 🎙️ Wake Word — "Hey Mark"
...
```bash
git clone https://github.com/Tusharsinghoffical/Personal-Assistant.git
...
Engineered by **Tushar Singh** — building a real-world JARVIS-style assistant.
⭐ **Star the repository to support the journey to Mark 100.**

| Platform | Link |
| --- | --- |
| GitHub | [@Tusharsinghoffical](https://github.com/Tusharsinghoffical) |
| YouTube | [Tushar Singh](https://www.youtube.com) |
| Instagram | [Tushar Singh](https://www.instagram.com) |
