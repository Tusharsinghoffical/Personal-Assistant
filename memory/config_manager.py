...
def get_assistant_name() -> str:
    """Return the configured assistant name, or 'Mark' if not set."""
    return load_api_keys().get("assistant_name", "Mark") or "Mark"
...
def save_assistant_config(assistant_name: str, user_name: str) -> None:
    ...
    if CONFIG_FILE.exists():
        try:
            ...
            data = {}
    data["assistant_name"] = assistant_name.strip() or "Mark"
