...
The optional local wake word ("Hey Mark") is NOT installed here — it's a
...
def main() -> None:
    print(f"⚙  Mark setup — detected OS: {OS or 'unknown'}")
    ...
    print("   3) (Optional) Enable 'Hey Mark' from ⚙ → WAKE WORD.")
